# NeuraReport Feature Validation Tracker

Source: FEATURES.md (duplicated on 2026-01-26)
Legend: [ ] Not tested, [-] In progress, [x] Done, [!] Blocked
...
- [x] Connection management (CRUD operations)
- [x] Connection health checking and validation
- [x] Schema browser for database exploration
- [x] Data preview from database tables
...
- [x] Real-time collaboration sessions
- [x] Presence awareness for collaborators
- [ ] PDF operations:
...
### 5. Ingestion & Import
- [x] File upload (single, bulk, ZIP archives)
- [x] URL-based ingestion and download
- [x] Structured data import (JSON, XML, YAML)
...
- [x] Regular expression search (with ReDoS protection)
- [x] Boolean search (AND, OR, NOT operators)
- [x] Search and replace across documents
- [x] Similar document detection
- [x] Saved searches management
- [x] Search indexing and analytics
