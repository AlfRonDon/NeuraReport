...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument('--warn-bytes', type=int, default=default_warn_bytes, help='Warn if artifact exceeds this many bytes.')
    parser.add_argument('--warn-render-ms', type=int, default=default_warn_render_ms, help='Warn if render time exceeds this many ms.')
