import{a8 as b,a9 as C,r as w,aa as k,j as h,ab as x,ac as S,N as R,at as $,bV as u,k as f,g as M}from"./index-DeRHNZar.js";function U(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function A(t){return parseFloat(t)}function j(t){return b("MuiSkeleton",t)}C("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const K=t=>{const{classes:e,variant:a,animation:n,hasChildren:s,width:i,height:o}=t;return S({root:["root",a,n,s&&"withChildren",s&&!i&&"fitContent",s&&!o&&"heightAuto"]},j,e)},r=f`
  0% {
    opacity: 1;
  }
