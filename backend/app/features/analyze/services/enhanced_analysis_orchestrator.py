...
from backend.app.features.analyze.services.enhanced_extraction_service import (
    EnhancedExtractionService,
)
from backend.app.features.analyze.services.analysis_engines import (
    AnalysisEngineService,
)
from backend.app.features.analyze.services.visualization_engine import (
    VisualizationEngine,
)
from backend.app.features.analyze.services.data_transform_export import (
    DataExportService,
)
from backend.app.features.analyze.services.advanced_ai_features import (
    AdvancedAIService,
)
from backend.app.features.analyze.services.user_experience import (
    UserExperienceService,
    StreamingAnalysisSession,
)
from backend.app.features.analyze.services.integrations import (
    IntegrationService,
)
from backend.app.features.analyze.services.extraction_pipeline import (
    ExtractedContent,
...
["Question 1", "Question 2", "Question 3"]"""
    ...
    async def compare_documents(
        ...
        from backend.app.features.analyze.services.analysis_engines import compare_documents
