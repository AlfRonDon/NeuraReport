...
from backend.app.features.analyze.schemas.analysis import (
    AnalysisResult,
...
_ANALYSIS_CACHE = TTLCache(
    max_items=_settings.analysis_cache_max_items,
    ttl_seconds=_settings.analysis_cache_ttl_seconds,
)
...
def _get_analysis_semaphore() -> asyncio.Semaphore:
    ...
    if _ANALYSIS_SEMAPHORE is None:
        _ANALYSIS_SEMAPHORE = asyncio.Semaphore(max(1, int(_settings.analysis_max_concurrency or 1)))
